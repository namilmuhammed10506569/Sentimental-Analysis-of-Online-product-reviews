...
#cross_validation is not a module since v0.18. If you want to use cross-validation tools such as cross_val_score or cross_validate,
# you should import them from the model_selection module.
...
def load_file():
    with open('review1.csv',encoding="utf8") as csv_file:
